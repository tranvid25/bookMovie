...
import { HomeOutlined, UserOutlined, BankOutlined, VideoCameraOutlined, FormOutlined, QuestionOutlined, LineChartOutlined, BellOutlined } from '@ant-design/icons';
...
export const AdminTemplate = (props) => { //path, exact, Component
  ...
  console.log('AdminTemplate - userLogin.role:', userLogin.role);
  console.log('AdminTemplate - TOKEN:', localStorage.getItem(TOKEN));
  ...
  const items = (userLogin.role === 'Super') ? [
    ...
    getItem('Quản Lý Thông Báo', '11', <NavLink className='text-decoration-none' to="/admin/notificationmng"><BellOutlined /></NavLink>),
  ] : [
    getItem('Quản Lý Phim', 'sub1', <VideoCameraOutlined />, [
      getItem('Danh Sách Phim', '1', <NavLink className='text-decoration-none' to="/admin/moviemng"><VideoCameraOutlined /></NavLink>),
      getItem('Danh Sách Carousel', '2', <NavLink className='text-decoration-none' to="/admin/carouselmng"><VideoCameraOutlined /></NavLink>),
    ...
    getItem('Quản Lý Thông Báo', '6', <NavLink className='text-decoration-none' to="/admin/notificationmng"><BellOutlined /></NavLink>),
  ]
