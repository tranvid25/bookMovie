          ...
          <div className="col-12">
            <div className="body">
              <p className="body_text">
                TQV CINEMA trực thuộc TQV Group, một trong những tập đoàn kinh
                tế đa ngành lớn nhất Việt Nam. TQV nằm trong trong top 05 cụm
                rạp chiếu phim lớn nhất toàn cầu và là nhà phát hành, cụm rạp
                chiếu phim lớn nhất tại Việt Nam.
              </p>
              ...
              <ul className="history">
                <li className="history__list">
                  ...
                  <p className="history__text">
                    Công ty TNHH Truyền thông TQV được thành lập
                  </p>
                </li>
                ...
                <li className="history__list">
                  ...
                  <p className="history__text">
                    Trang Web Đặt Vé Xem Phim TQV được thành lập
                  </p>
                </li>
                ...
                <li className="history__list">
                  ...
                  <p className="history__text">
                    Trang Web Đặt Vé Xem Phim TQV được đưa vào sử dụng
                  </p>
                </li>
              </ul>
              <p className="body_text">
                ...
                nghiệp phong cách sống toàn cầu. TQV Việt Nam mong muốn mang đến
                nhiều cơ hội việc làm cho các tài năng trẻ, năng động và yêu
                thích ngành công nghiệp điện ảnh.
              </p>
              <p className="body_text">
                Chúng tôi chào đón bạn gia nhập đại gia đình TQV Việt Nam thông
            ...
            <div className="row">
              <div className="col-6">
                ...
                <div className="application">
                  ...
                  <p className="body_text">
                    <strong>Cách 1 :</strong> Gửi CV đến email TQVtalent@TQV.com
                    với tiêu đề "[HỌ TÊN] - Ứng tuyển [VỊ TRÍ]”.
                  </p>
                  <p className="body_text">
                    <strong>Cách 2 :</strong> Nộp hồ sơ trực tiếp trên các trang
                    tuyển dụng uy tín mà TQV có đăng tuyển như Linkedin,
              ...
              <div className="col-6">
                ...
                <div className="application">
                  ...
                  <p className="body_text">
                    ...
                    Service của cụm rạp TQV mà bạn muốn ứng tuyển.
                  </p>
                  <p className="body_text">
                    <strong>Cách 2 :</strong> Theo dõi thông tin tuyển dụng trên
                    Facebook - TQV Careers.
                  </p>
                  <p className="body_text">
                    <em>
                      {" "}
                      <strong>*Đối tượng:</strong> dành cho sinh viên{" "}
                    </em>
                  </p>
                </div>
              </div>
            ...
            <p className="body_text">
              TQV KHÔNG thu bất kỳ chi phí tuyển dụng nào dưới mọi hình thức
              (phí hồ sơ, đồng phục….).
            </p>
            <p className="body_text">
              Với những vị trí cho khối Cụm Rạp, TQV KHÔNG tuyển nhân viên thông
              qua đơn vị khác.
            </p>
          </div>
        </div>
